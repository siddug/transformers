...
class BigramLanguageModel(nn.Module):
  ...
  def forward(self, idx, targets=None):
    # each integer in the vocabulary/ each character in the vocabulary is mapped to a unique embedding vector
    # in a simple bigram model, the embeddings here represent the probabilites of each char in the vocabulary appearing next for a given input char
